...
def build_original_hk_island_load_table(df):
    ...
    should_total_hours = (end_time - begin_time).days * 24
...
def read_data(data, cluster, context_a, context_b):
    # load data
    ...
    # with open('./tmp_pkl_data/cluster_{}_ashrae_{}_to_{}_cl.pkl'.format(cluster, context_a, context_b), 'wb') as w:
    #     pickle.dump(save_dict, w)
    # print('data saved at: ./tmp_pkl_data/cluster_{}_ashrae_{}_to_{}_cl.pkl'.format(cluster, context_a, context_b))
